...
schools <- read.csv("dsan5100_project/data/school_info/school_info.csv",header = TRUE) 
...
d1_schools <- read.csv('dsan5100_project/Name_Standardizations.csv')
...
str(d1_schools)
write.csv(d1_schools,'dsan5100_project/UNITID_school_names.csv',row.names = FALSE)
```

Get the population data for the schools
```{r}
# do it for first file in folder
f = 'dsan5100_project/data/raw_pop_data/ef2017a.csv'
...
pop_df <- merge(d1_schools, file_agg, by="UNITID", all.x = TRUE) |> arrange(d1_id) |> select(-short_name)
str(pop_df)
```
...
```{r}
pop_df <- load_pop_data('dsan5100_project/data/raw_pop_data/ef2018a.csv', pop_df)
pop_df <- load_pop_data('dsan5100_project/data/raw_pop_data/ef2019a.csv', pop_df)
pop_df <- load_pop_data('dsan5100_project/data/raw_pop_data/ef2020a.csv', pop_df)
pop_df <- load_pop_data('dsan5100_project/data/raw_pop_data/ef2021a.csv', pop_df)
pop_df <- load_pop_data('dsan5100_project/data/raw_pop_data/ef2022a.csv', pop_df)
...
```{r}
write.csv(pop_df,'dsan5100_project/data/clean_pop_data/school_pops_2018-2023.csv', row.names = FALSE)
```
